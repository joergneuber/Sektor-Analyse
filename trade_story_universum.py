...
def build_trade_story_universe(paths: dict[str, str], observation_path: str | None = None) -> dict[str, Any]:
    ...
    # A = candidate, B = prepared, C/KEIN KANDIDAT/NICHT AUSGELESEN = excluded.
    # No status is invented from historical data; only the latest artifact status
    # selected above is allowed to enter the Trade Story.
