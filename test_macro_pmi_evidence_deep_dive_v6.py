...
OUT = Path("macro_pmi_evidence_v6")
...
def main():
    print("=== PMI EVIDENCE DEEP DIVE V6 ===")
    print("MODE=READ_ONLY|NON_ABORTING|MULTI_ROUTE")
    print("TARGETS=TE_SERVICES|TE_NON_MANUFACTURING|SPG_DE|SPG_EN")
