...
Dollarzeichen-Escaping (NEU): Schreibe JEDEN USD-Betrag mit einem Backslash vor dem Dollarzeichen, also \$ statt $ (z. B. 61,00\$ statt 61,00$). Grund: Zwei nicht-escapte $-Zeichen im selben Textblock werden vom Markdown-Renderer als LaTeX-Formel interpretiert (erkennbar an fehlerhaft gerendertem Text oder \vert{} statt |) – das betrifft ALLE USD-Beträge in der gesamten Ausgabe (Trade-Übersicht UND Offene Positionen), nicht nur einzelne Felder. Bei EUR-Beträgen (€) ist kein Escaping nötig, das Problem betrifft ausschließlich das Dollarzeichen.
...
Name: {{Name}} | Ticker: {{Ticker}} | Markt: {{Markt}} | Sektor: {{Sektor}} Aktueller Kurs: {{Kurs, IMMER 2 Nachkommastellen, z. B. 61,00}}{{Waehrungssymbol, bei USD als \$ escaped}} Technisches Kursziel: {{Tech-Kursziel, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} Analysten-Kursziel: {{Analysten-Kursziel, 2 Nachkommastellen, oder "N/A"}}{{Waehrungssymbol, bei USD als \$ escaped}} TP1: {{TP1, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | CRV1: {{CRV1, 2 Nachkommastellen}} TP2: {{TP2, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | CRV2: {{CRV2, 2 Nachkommastellen}} Stop-Loss: {{Stop, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | Risiko: {{Risk_Perc, 2 Nachkommastellen}}% RSI: {{RSI, 2 Nachkommastellen}} | MACD-Trend: {{MACD_Trend}} Setup-Qualität: [{{Feinstufe aus der 6-stufigen Skala: B-/B/B+/A-/A/A+}}] Sektor-Momentum: {{5T, 2 Nachkommastellen}}% (5 Tage) / {{12T, 2 Nachkommastellen}}% (12 Tage), Rotation-Score {{Rotation-Score}} Vol-Ratio: {{Vol_Ratio, 2 Nachkommastellen}}x RS vs. Benchmark: {{RS_vs_Benchmark%, 2 Nachkommastellen}}% Abstand 52W-Hoch: {{Abstand_52W_Hoch%, 2 Nachkommastellen}}% Divergenz: {{Divergenz}} Ereignis-Kontext: {{Earnings-Warnung falls vorhanden}} | {{ALLE News-Zeilen des Titels 1:1 – Pflicht sobald vorhanden}}
...
Festes Ausgabe-Format je Position (NEU): {{Ticker}} ({{Firmenname}}) | Markt: {{Markt}} | Einstieg: {{Einstieg, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} ({{Einstiegsdatum}}) | Aktuell: {{Aktuell, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | Performance: {{Performance, 2 Nachkommastellen}}% | Stop: {{Stop, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | TP1: {{TP1, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | TP2: {{TP2, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} — diese Reihenfolge und Feld-Auswahl gilt für JEDE Position identisch, keine Abweichungen.
...
Festes Ausgabe-Format je Trendwende-Titel: {{Ticker}} ({{Name}}) | Markt: {{Markt}} | Sektor: {{Sektor}} Kurs: {{Kurs, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | Stop: {{Stop, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | Risiko: {{Risk_Perc, 2 Nachkommastellen}}% TP1: {{TP1, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | CRV1: {{CRV1, 2 Nachkommastellen}} | TP2: {{TP2, 2 Nachkommastellen}}{{Waehrungssymbol, bei USD als \$ escaped}} | CRV2: {{CRV2, 2 Nachkommastellen}} RSI: {{RSI, 2 Nachkommastellen}} | MACD-Trend: {{MACD_Trend}} | Vol-Ratio: {{Vol_Ratio, 2 Nachkommastellen}}x Abstand 52W-Tief: {{Abstand_52W_Tief%, 2 Nachkommastellen}}% | RS vs. Benchmark: {{RS_vs_Benchmark%, 2 Nachkommastellen}}% Setup-Typ: {{Setup_Typ}} | Qualitäts-Bonus: {{Qualitaets_Bonus, wörtlich aus der CSV}} ⚠ Risikohinweis: {{Risikohinweis, wörtlich aus der CSV übernehmen}}
