        ...
        try:
            ...
            antwort = client.models.generate_content(
                ...
                contents=hochgeladene_teile + [
                    ...
                    "PRIORITAET FRUEHE ENTDECKUNG: Suche zuerst nach Veraenderungen und Querzusammenhaengen ueber Makro, Geopolitik, Oel/Rohstoffe, Inflation, Zentralbanken, Zinsen, Liquiditaet, Waehrungen, Sektoren und Marktstruktur. Suche nicht nur nach bereits vorhandenen Setups. Wenn mehrere Datenbereiche auf dasselbe grosse Thema hindeuten, formuliere daraus eine eigenstaendige fruehe These. Pruefe anschliessend, ob dafuer bereits ein technischer Kandidat existiert oder ob die These noch ohne Kandidat beobachtet werden muss. "
